...
public class CustomerControllerTest {
	...
	public static HoverflyRule hoverflyRule = HoverflyRule
			.inSimulationMode(dsl(
					service("account-service:8091").andDelay(200, TimeUnit.MILLISECONDS).forAll()
							.get(startsWith("/customer/"))
							.willReturn(success("[{\"id\":\"1\",\"number\":\"1234567890\",\"balance\":5000}]",
									"application/json")),
					service("account-service:9091").andDelay(2000, TimeUnit.MILLISECONDS).forAll()
							.get(startsWith("/customer/")).willReturn(
	...
	public void testCustomerWithAccounts() {
		...
		LOGGER.info("TEST RESULT: 8091={}, 9091={}", a, d);
	}
